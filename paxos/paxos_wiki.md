# Paxos算法
> 学习Paxos算法， 觉得wiki 上解释的挺不错， 就搬过来了
[Paxos算法 wiki](https://zh.wikipedia.org/wiki/Paxos%E7%AE%97%E6%B3%95)
...
- **P2c：如果一个编号为n的提案具有value v，那么存在一个多数派，要么他们中所有人都没有接受（accept）编号小于n 的任何提案要么他们已经接受（accept）的所有编号小于n的提案中编号最大的那个提案具有value v**
